    ...
    <div className="container">
      <div className="row pt-4 pb-0 pb-md-5">
        <div className="col-md-6">
          <div className="tastebite-footer-contnet pr-0 pr-lg-5 mr-0 mr-md-5">
            <a href="index.html">
              <img src="assets/images/brands/brand4.svg" alt="Tastebite"/>
            </a>
            <p className="mt-3 text-gray-300 pr-0 pr-lg-5 mr-0 mr-lg-4">"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment</p>
          </div>
        </div>
    ...
    <div className="container">
      ...
      <div className="row pb-4 pt-2 align-items-center">
        <div className="col-md-6 order-2 order-md-0">
          <p className="text-gray-300 small text-left mb-0">&copy; 2020 Tastebite - All rights reserved</p>
        </div>
        <div className="col-md-6">
          <div className="tstbite-social text-left text-md-right my-4 my-md-0">
            <a href="#0">
